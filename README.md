...
## Dependencies
### Depending on Modloader
[![Fabric API Button](https://tlotd.net/minecraft/mod/fabric_api.svg)](https://modrinth.com/mod/fabric-api)
[![Quilted Fabric API Button](https://tlotd.net/minecraft/mod/quilted_fabric_api.svg)](https://modrinth.com/mod/qsl)
...
- 🇩🇪 [Deutsch (Deutschland)](https://github.com/tlotd/Fabric/blob/1.20.1/src/main/resources/assets/tlotd/lang/de_de.json) [100%] - Translators: [@tlotd](https://github.com/tlotd), [@isla_nublar](https://github.com/Isla-Nublar)
- 🇩🇪 [Schwäbisch (s' Ländle)](https://github.com/tlotd/Fabric/blob/1.20.1/src/main/resources/assets/tlotd/lang/sch_de.json) [100%] - Translators: [@tlotd](https://github.com/tlotd), [@isla_nublar](https://github.com/Isla-Nublar) | [(Schwabenpatch Required)](https://github.com/tlotd/Schwabenpatch)
...
- [![TLOTD Wiki](https://tlotd.net/wiki/assets/guidebook.png) TLOTD Wiki](https://tlotd.net/wiki/guidebook)
