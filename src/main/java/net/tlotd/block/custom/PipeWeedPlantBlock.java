...
public class PipeWeedPlantBlock extends CropBlock {
    ...
    public PipeWeedPlantBlock(Settings settings) {
        super(settings);
    ...
    protected ItemConvertible getSeedsItem() {
        return ModItems.PIPE_WEED_SEEDS;
    }
    ...
    public void applyGrowth(World world, BlockPos pos, BlockState state) {
        ...
        if (nextAge < TOP_START) {
            ...
            world.setBlockState(pos, this.withAge(nextAge).with(HALF, DoubleBlockHalf.UPPER).with(IGNORE,true), 0);
    ...
    public static final VoxelShape STAGE_0 = Block.createCuboidShape(5, 0, 5, 11, 4, 11);
    public static final VoxelShape STAGE_1 = Block.createCuboidShape(3, 0, 3, 13, 7, 13);
    public static final VoxelShape STAGE_2 = Block.createCuboidShape(3, 0, 3, 13, 12, 13);
    public static final VoxelShape STAGE_3 = Block.createCuboidShape(2, 0, 2, 14, 15, 14);
    public static final VoxelShape STAGE_4 = Block.createCuboidShape(5, 0, 5, 11, 5, 11);
    public static final VoxelShape STAGE_5 = Block.createCuboidShape(3, 0, 3, 13, 9, 13);
    public static final VoxelShape STAGE_6 = Block.createCuboidShape(1, 0, 1, 15, 14, 15);
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return switch (state.get(AGE)) {
            ...
            case 2 -> STAGE_2;
            case 3 -> STAGE_3;
            case 4 -> {if(state.get(HALF) == DoubleBlockHalf.UPPER){yield STAGE_4;}else{yield DEFAULT;}}
            case 5 -> {if(state.get(HALF) == DoubleBlockHalf.UPPER){yield STAGE_5;}else{yield DEFAULT;}}
            case 6,7 -> {if(state.get(HALF) == DoubleBlockHalf.UPPER){yield STAGE_6;}else{yield DEFAULT;}}
            default -> DEFAULT;
        };
    }
}