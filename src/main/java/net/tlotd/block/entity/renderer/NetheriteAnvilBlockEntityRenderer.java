...
public class NetheriteAnvilBlockEntityRenderer implements BlockEntityRenderer<NetheriteAnvilBlockEntity> {
    public NetheriteAnvilBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
    }

    @Override
    public void render(NetheriteAnvilBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
