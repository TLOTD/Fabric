...
public class BlockLogicCinnabarOre extends BlockLogic {
	...
	public BlockLogicCinnabarOre(Block<?> block, Block<?> parentBlock, Material material) {
	...
	public ItemStack[] getBreakResult(@NotNull World world, EnumDropCause dropCause, int meta, TileEntity tileEntity) {
		return switch (dropCause) {
			...
			case EXPLOSION, PROPER_TOOL, PISTON_CRUSH -> new ItemStack[]{new ItemStack(ModItems.CINNABAR_CRYSTAL)};
			default -> null;
		};
	}
}
