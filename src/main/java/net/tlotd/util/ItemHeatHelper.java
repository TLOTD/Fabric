...
public class ItemHeatHelper {
    ...
    public static Text getTemperatureText(int temp) {
        String TempRange;
        if (temp >= 6000) {
            TempRange = "6000";
            //return Text.translatable("temperature.tlotd.6000.tengwar").setStyle(Style.EMPTY.withFont(new Identifier("tlotd", "tengwar")).withColor(Formatting.WHITE));
        } else if (temp >= 5900) {
            TempRange = "5900";
        } else if (temp >= 5800) {
            TempRange = "5800";
        ...
        return Text.translatable("temperature.tlotd." + TempRange).setStyle(Style.EMPTY.withColor(getTemperatureColor(temp)));
    }
