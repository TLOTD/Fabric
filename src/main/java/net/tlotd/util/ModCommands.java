    ...
    public static void registerCommands() {
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            dispatcher.register(CommandManager.literal("tlotd").then(CommandManager.literal("temperatureUnit").executes(ctx -> {
                ...
                Text message = Text.literal("https://tlotd.net/wiki/mc-mod/").styled(style -> style.withColor(Formatting.GOLD).withUnderline(true).withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://tlotd.net/wiki/mc-mod/")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Text.literal("Open in browser"))));
