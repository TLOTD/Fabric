...
public class ModBlockRenderLayerMap {
    public static void registerBlockRenderLayerMaps() {
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_BOILING_WATER, ModFluids.FLOWING_BOILING_WATER);
        ...
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_HOT_COFFEE, ModFluids.FLOWING_HOT_COFFEE);
        ...
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_MOLTEN_MITHRIL, ModFluids.FLOWING_MOLTEN_MITHRIL);

        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.APPARATUS, RenderLayer.getTranslucent());

        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DARK_METAL_LIGHTS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.HEAVY_METAL_DOOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.METAL_PUSH_DOOR, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.EXTINGUISHED_COPPER_TORCH, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.EXTINGUISHED_COPPER_WALL_TORCH, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.VERTICAL_FRAMED_GLASS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.VERTICAL_FRAMED_GLASS_PANE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ROUND_FRAMED_GLASS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ROUND_FRAMED_GLASS_PANE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.SPLIT_FRAMED_GLASS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.SPLIT_FRAMED_GLASS_PANE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TILED_FRAMED_GLASS, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TILED_FRAMED_GLASS_PANE, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CHRISTMAS_WREATH, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.ADVENT_WREATH, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.STACKABLE_BOOK, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BEER_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.MEAD_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BLOOD_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BOILING_WATER_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.HOT_COFFEE_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.HOT_MILK_CAULDRON, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.HOT_CHOCOLATE_CAULDRON, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BACKSHROOM_DOOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.BACKSHROOM_TRAPDOOR, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.WOODEN_BOILING_WATER_STEIN, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.WOODEN_HOT_COFFEE_STEIN, RenderLayer.getCutout());
