...
public class TRexAnimations {
    public static final Animation ANIM_TREX_IDLE = Animation.Builder.create(4.5F).looping()
    ...
    public static final Animation ANIM_TREX_ATTACK = Animation.Builder.create(0.5F)
    ...
    public static final Animation ANIM_TREX_WALK = Animation.Builder.create(4.0F).looping()
