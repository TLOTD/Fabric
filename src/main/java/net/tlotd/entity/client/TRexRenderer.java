    ...
    public static final Map<TRexVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(TRexVariant.class), (map) -> {
                map.put(TRexVariant.BROWN,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/brown.png"));
                map.put(TRexVariant.GREEN,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/green.png"));
                map.put(TRexVariant.GRAY,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/gray.png"));
                map.put(TRexVariant.SCULK,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/sculk.png"));
                map.put(TRexVariant.INFECTED,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/infected.png"));
                map.put(TRexVariant.SICKENED,
                        new Identifier(TLOTD.MOD_ID, "textures/block/t-rex/sickened.png"));
            });
