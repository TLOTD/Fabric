...
public class CompatSwordItem extends SwordItem {
    ...
    public CompatSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings, String compat) {
