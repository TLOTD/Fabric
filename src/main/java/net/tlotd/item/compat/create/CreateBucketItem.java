...
public class CreateBucketItem extends BucketItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (context.isCreative()){
            ...
            tooltip.add(Text.literal("\uE001 ").setStyle(style.withFont(MODS_FONT_ID)).append(Text.translatable("itemGroup.create.base").setStyle(style.withFont(DEFAULT_FONT_ID).withFormatting(Formatting.GRAY))));
        }
