...
public class ModCompostingChances {
    public static void registerCompostableItems() {
		...
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.PIPE_WEED_SEEDS, 0.3f);
		...
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModBlocks.SHELF_MUSHROOM.asItem(), 0.65f);
		...
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.HEMP_COOKIE, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.SWEET_BERRY_JAM_TOAST, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.GLOW_BERRY_JAM_TOAST, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.STRAWBERRY_JAM_TOAST, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.ORANGE_MARMELADE_TOAST, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.BLUE_BERRY_JAM_TOAST, 0.85f);
		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.DROOPFRUIT_JAM_TOAST, 0.85f);

		ComposterBlock.ITEM_TO_LEVEL_INCREASE_CHANCE.put(ModItems.ANCIENT_SOULBERRY_JAM_TOAST, 1f);
        ...
        TLOTD.LOGGER.info("Registering Compostable Items for " + TLOTD.MOD_ID);
    }
}
