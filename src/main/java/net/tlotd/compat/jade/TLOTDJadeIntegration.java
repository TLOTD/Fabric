...
public class TLOTDJadeIntegration implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerBlockDataProvider(OxygenCollectorComponentProvider.INSTANCE, OxygenCollectorBlockEntity.class);
        ...
        registration.registerBlockDataProvider(SignalTransmitterComponentProvider.INSTANCE, SignalTransmitterBlockEntity.class);
    }
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.hideTarget(ModBlocks.YELLOW_WALLPAPERED_WALL_WITH_BASEBOARD_AND_OUTLET);
        ...
        registration.registerBlockComponent(OxygenCollectorComponentProvider.INSTANCE, OxygenCollectorBlock.class);
        ...
        registration.registerBlockComponent(SignalTransmitterComponentProvider.INSTANCE, SignalTransmitterBlock.class);
