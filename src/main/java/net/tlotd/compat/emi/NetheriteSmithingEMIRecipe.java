...
public class NetheriteSmithingEMIRecipe implements EmiRecipe {

    private final NetheriteSmithingRecipe recipe;

    public NetheriteSmithingEMIRecipe(NetheriteSmithingRecipe recipe) {
        this.recipe = recipe;
    }

    @Override
    public EmiRecipeCategory getCategory() {
        return NetheriteSmithingEMICategory.CATEGORY;
    }
    ...
    public void addWidgets(WidgetHolder widgets) {
        widgets.addTexture(new Identifier(TLOTD.MOD_ID, "textures/gui/rei/netherite_anvil.png"), 0, 0, 134, 44, 4, 4);
